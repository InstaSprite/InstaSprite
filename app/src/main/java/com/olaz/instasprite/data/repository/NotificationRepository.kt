...
class NotificationRepository @Inject constructor(
    ...
    suspend fun getNotifications(page: Int, size: Int = 20): Result<com.olaz.instasprite.data.network.model.SpringPageDto<com.olaz.instasprite.data.network.model.NotificationDto>> {
        return try {
