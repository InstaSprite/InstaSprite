...
enum class BrushShape(val icon: Int, val nameRes: Int) {
    Circle(R.drawable.ic_circle_shape, R.string.tool_circle),
    Square(R.drawable.ic_square_shape, R.string.shape_square)
}
